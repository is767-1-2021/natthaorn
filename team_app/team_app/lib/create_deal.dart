        ...
        children: [
          ...
          TextFormField(
            decoration: InputDecoration(
                border: UnderlineInputBorder(), labelText: 'type your deal'),
            validator: (value) {
          ...
          TextFormField(
            decoration: InputDecoration(
                border: UnderlineInputBorder(), labelText: 'type something'),
            validator: (value) {
              if (value == null || value.isEmpty) {
          ...
          TextFormField(
            decoration: InputDecoration(
                border: UnderlineInputBorder(), labelText: 'Your Deal at ...'),
            validator: (value) {
              if (value == null || value.isEmpty) {
